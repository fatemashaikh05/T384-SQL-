...
from Employee join Address
On employee.EmployeeId=address.EmployeeId;
-- left join --
select employee.EmployeeId,FullName,ProjectId,ProjectName
from Employee Left join Projects
On employee.EmployeeId=projects.EmployeeId;
-- right join --
select projects.EmployeeId,FullName,ProjectId,ProjectName
from Employee Right join Projects
On employee.EmployeeId=projects.EmployeeId;
-- same output as upper query but using left join --
select projects.EmployeeId,FullName,ProjectId,ProjectName
...
from Projects left join Employee
On employee.EmployeeId=projects.EmployeeId
where projects.EmployeeId>1004;
